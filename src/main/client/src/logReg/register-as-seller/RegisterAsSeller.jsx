            ...
            <div className="w-auto flex justify-center">
                <div className="text-center h-auto bg-violet-300 login-container mt-24 border-b-8 border-violet-500">
                    ...
                    <form className={"text-center p-4"}>
                        <input className={"mb-8 text-3xl text-center"} placeholder={"Название Магазина"}
                               type={"text"}></input>
                        <br/>
                        ...
                        <br/>
                        <button
                            className={"mt-4 p-2 text-2xl bg-amber-300 border-b-4 border-amber-600"}>Зарегистрироваться
                        </button>
                    </form>
                </div>
            </div>
